(function () {
  ...
  var zhText = {
    ...
    "Log": "日志",
    "About": "关于",
    "Agent systems / product UI": "Agent 系统 / 产品界面",
    "AI Systems Studio": "AI 系统工作室",
    "AI agents,": "把 Agent 做到",
    "beyond the demo": "Demo 之后",
    "AI systems": "有界面品味的",
    "with interface taste": "AI 系统",
    "I work on the unglamorous parts that decide whether an AI product can ship: tool calls, retrieval misses, handoff rules, evaluation traces, and the interface details users actually touch.": "我做的是 AI 产品能不能上线的那部分：工具调用、检索失误、转人工边界、评估轨迹，以及用户真正会碰到的界面细节。",
    ...
    "Turning agent workflows into product surfaces": "把 Agent 工作流打磨成产品界面",
    "Now building agent-facing product systems": "正在构建面向 Agent 的产品系统",
    "Systems": "系统",
    "Agent work that has left the notebook": "已经离开笔记本的 Agent 工作",
    "Shipped AI systems in production": "已落地的生产级 AI 系统",
    "Prototypes": "原型",
    "Small interfaces for messy workflows": "给复杂流程做的小界面",
    "Interfaces, tools, and product experiments": "界面、工具和产品实验",
    "Notes": "笔记",
    "Debug logs and product thinking": "排查记录和产品判断",
    "Thinking, patterns, and engineering observations": "思考、模式与工程观察",
    "Studio Method": "工作室方法",
    "How fuzzy AI work becomes shipped behavior": "模糊 AI 需求如何变成可交付行为",
    ...
    "Latest note": "最新笔记",
    "Tool calling failure analysis": "Tool calling 失效排查",
    "Curtis Mei": "梅志扬",
    "AI systems, product prototypes, and tooling for agent workflows. I turn messy RAG, tool-calling, evaluation, and support flows into small software surfaces people can actually use. Based in Shenzhen - nice to meet you.": "AI 系统、产品原型，以及面向 Agent 工作流的工具。我把混乱的 RAG、工具调用、评估和客服流程，变成用户真正能用的小型软件界面。常驻深圳，很高兴认识你。",
    "I build AI-facing product systems: agent deployment, RAG pipelines, tool-calling workflows, evaluation traces, and interfaces that users can actually understand.": "我构建面向 AI 的产品系统：Agent 部署、RAG 管线、工具调用工作流、评估轨迹，以及用户真正能理解的界面。",
    "Currently turning ambiguous AI workflows into small, shippable systems. Based in Shenzhen, working with product teams that care about the details after the demo.": "我正在把模糊的 AI 工作流变成小而可交付的系统。常驻深圳，和在意 Demo 之后那些细节的产品团队合作。",
    "GitHub": "GitHub",
    "Email": "邮件",
    "\"Tools should feel quiet when they work, and honest when they fail.\"": "工具顺手时应该安静，失败时应该诚实。",
    "01 Projects": "01 项目",
    "MY_MAP": "MY_MAP",
    "AI-powered mapping assistant for plan creation, route intelligence, and location-aware recommendations.": "用于计划生成、路线智能和位置感知推荐的 AI 地图助手。",
    "Live Chat Widget Integration": "Live Chat Widget 集成",
    "Embeddable AI support chat with knowledge-base answers, handoff, and customer-service workflows.": "可嵌入网站的 AI 客服对话组件，支持知识库回答、转人工和客服工作流。",
    "Food Poisoning Questionnaire System": "食物中毒问卷系统",
    "Conversational intake and questionnaire management for health triage and structured risk guidance.": "面向健康分诊和结构化风险指引的对话式问卷采集与管理系统。",
    "02 Experiments": "02 实验",
    "AI Model Modulation": "AI 模型调制",
    "Research-backed model behavior control with logits redistribution and evaluation-facing framing.": "基于研究的模型行为控制实验，通过 logits 重新分布和面向评估的框架来约束输出。",
    "Email Processing System": "邮件处理系统",
    "Cleaning and transforming email archives into retrieval-ready knowledge-base material.": "清洗并转换邮件档案，使其成为可检索的知识库材料。",
    "GreenGo / Portfolio Systems": "GreenGo / Portfolio 系统",
    "Product prototypes": "产品原型",
    "Interface experiments across community platforms, data views, and full-stack web prototypes.": "围绕社区平台、数据视图和全栈 Web 原型的界面实验。",
    "03 Writings": "03 文章",
    "02 Notes": "02 笔记",
    "When an agent learns to be lazy": "当 Agent 学会偷懒",
    "A practical debugging note about tool calling failures in a real agent workflow.": "一次真实 Agent 工作流里的工具调用失效排查笔记。",
    "From smolagents to agents and tool calling": "从 smolagents 聊 Agent 与 Tool Calling",
    "An engineering-oriented look at how tools, model reasoning, and execution loops fit together.": "从工程视角观察工具、模型推理和执行循环如何协作。",
    "Tool calling as an agent interface": "作为 Agent 界面的 Tool Calling",
    "Engineering notes on function signatures, execution loops, and product-side safety expectations.": "关于函数签名、执行循环和产品侧安全预期的工程笔记。",
    "Maintainability notes for support agents": "客服 Agent 的可维护性笔记",
    "Handoff boundaries, product ownership, and keeping support AI understandable.": "关于人工交接边界、产品责任归属，以及让客服 AI 保持可理解。",
    "04 What Shapes Me": "04 塑造我的东西",
    "Product design and user experience": "产品设计与用户体验",
    "Product design notes on interface feeling, user perception, and why capability still needs taste.": "关于界面感受、用户感知，以及为什么能力之外仍然需要品味的产品设计笔记。",
    "03 Personal": "03 个人",
    "Games I have played": "我玩过的游戏",
    "A softer archive of play memories and interface taste beyond work.": "一份更柔软的游玩记忆，也记录工作之外的界面品味。",
    "Music collection": "我的音乐收藏",
    "Notes on music, collection habits, and the small tools around them.": "关于音乐、收藏习惯，以及围绕它们的小工具。",
    "Collection": "收藏",
    "Personal shelves, references, and fragments that shape the studio identity.": "个人书架、参考资料和塑造这个站点气质的碎片。",
    "04 Contact": "04 联系",
    "Contact": "联系",
    "If you want to talk about AI systems, product prototypes, or a workflow that needs to become software, write to me. I read carefully.": "如果你想聊 AI 系统、产品原型，或某个需要变成软件的工作流，欢迎写信给我。我会认真读。",
    "meizhiyang@gmail.com": "meizhiyang@gmail.com",
    "github.com/curtisyoung18": "github.com/curtisyoung18",
